...
class Solution {
    public int minDistance(String word1, String word2) {
        ...
        int ans = editDistance(word1,word2,m,n);
        return ans;
    }  
    public static int editDistance(String word1,String word2,int m,int n)
    {
        ...
        return 1 + Math.min(editDistance(word1,word2,m,n-1),Math.min(editDistance(word1,word2,m-1,n),
